          ...
          <div className="relative aspect-[16/9] md:aspect-[24/9] w-full overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 md:p-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div className="space-y-6 max-w-4xl">
                ...
                <div className="mt-8 flex flex-col gap-6 p-8 rounded-[2rem] bg-white/10 backdrop-blur-xl border border-white/20 w-fit min-w-[320px] shadow-2xl shadow-black/20">
                  <div className="flex items-center gap-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className={cn(
                        "px-3 py-1 rounded-lg border text-[10px] font-black uppercase tracking-[0.1em] inline-block shadow-sm",
                        scoreBadgeStyles
                      )}>
                        {scoreLabel}
                      </div>
